  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <View>
          <TextInput placeholder="Harga" placeholderTextColor="gray" style={styles.InputHarga} keyboardType="numeric" value={inputCurrency("20000")} />
        </View>

        <View style={{ marginVertical: 20 }}>
          <TouchableOpacity style={styles.ButtonSimpan}>
            <Text style={styles.textEdit}>Simpan</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  ContainerQty: { textAlign: 'center', justifyContent: "center", alignItems: "center", marginVertical: 20, flexDirection: "row" },
  InputHarga: {
    color: "#000",
    borderWidth: 1,
    borderColor: "#ececec",
